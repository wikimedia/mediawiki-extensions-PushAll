...
$messages['ko'] = array(
	...
	'push-tab-err-fileinfo' => '이 문서에 사용되는 파일을 가져올 수 없습니다. 아무것도 밀지 않았습니다.',
 ...
 */
$messages['pms'] = array(
	'push-desc' => 'Estension lingera për gionté ij contnù a àutre wiki',
	'right-push' => 'Autorisassion a dovré la funsion ed gionté.',
	'right-bulkpush' => 'Autorisassion a dovré la funsion ëd gionté a mugg (visadì Special:Push).',
	'right-pushadmin' => "Autorisassion a modifiché la destinassion ëd gionté e j'ampostassion ëd gionté.",
	'action-push' => 'gionta pagine',
	'action-bulkpush' => 'gionta pagine a mugg',
	'action-pushadmin' => 'configura ël gionté',
	'group-pusher' => 'Giontador',
	'group-pusher-member' => '{{GENDER:$1|giontador}}',
	'grouppage-pusher' => '{{ns:project}}:Giontador',
	'group-bulkpusher' => 'Giontador a mugg',
	'group-bulkpusher-member' => '{{GENDER:$1|giontador a mugg}}',
	'grouppage-bulkpusher' => '{{ns:project}}:Giontador a mugg',
	'group-filepusher' => "Giontador d'archivi",
	'group-filepusher-member' => "{{GENDER:$1|giontador d'archivi}}",
	'grouppage-filepusher' => "{{ns:project}}:Giontador d'archivi",
	'push-err-captacha' => 'As peul pa giontesse a $1 a motiv dla captcha.',
	'push-err-captcha-page' => 'As peul pa giontesse la pagina $1 a tute le destinassion a motiv dla CAPTCHA.',
	'push-err-authentication' => 'Autenticassion a $1 falìa. $2',
	'push-tab-text' => 'Gionta',
	'push-button-text' => 'Gionta',
	'push-tab-desc' => 'Sta scheda at përmëtt ëd gionté la revision corenta dë sta pagina a un-a o pi àutre wiki.',
	'push-button-pushing' => 'Gionté',
	'push-button-pushing-files' => 'Gionté archivi',
	'push-button-completed' => 'Argionta completà',
	'push-button-failed' => 'Argionta falìa',
	'push-tab-title' => 'Gionta $1',
	'push-targets' => 'Gionta destinassion',
	'push-add-target' => 'Gionta destinassion',
	'push-import-revision-message' => 'Giontà da $1.',
	'push-tab-no-targets' => 'A-i è gnun-e destinassion da gionté. Për piasì giontne quaidun-e a tò archivi LocalSettings.php.',
	'push-tab-push-to' => 'Gionta a $1',
	'push-remote-pages' => 'Pagine lontan-e',
	...
	'push-tab-last-edit' => 'Ultima modìfica da $1 dzor $2 a $3.',
	'push-tab-not-created' => "Sta pàgina-sì a esist pa anco'.",
	'push-tab-push-options' => 'Gionta opsion:',
	'push-tab-inc-templates' => 'Ciapa andrinta jë stamp',
	'push-tab-used-templates' => '(Stamp {{PLURAL:$2|dovrà}}: $1)',
	'push-tab-no-used-templates' => '(Gnun stamp a son dovrà dzor sta pagina.)',
	'push-tab-inc-files' => 'Comprend archivi ancorporà',
	'push-tab-err-fileinfo' => 'As peul pa otense che archivi a son dovrà dzor sta pagina. Gnun a son stàit giontà.',
	'push-tab-err-filepush-unknown' => "Argionta d'archivi falìa për na rason pa conossùa.",
...
$messages['pt-br'] = array(
	...
	'right-bulkpush' => 'Autorização para usar a funcionalidade de replicação externa em bloco (Special:Push).',
	...
	'push-tab-template-override' => 'Essas predefinições já existem: $1',
...
$messages['ta'] = array(
	...
	'push-tab-files-override' => 'இந்த கோப்புகள் ஏற்கனவே உள்ளன: $1',
	'push-tab-template-override' => 'இந்த் வார்ப்புருக்கள் ஏற்கனவே உள்ளன: $1',
