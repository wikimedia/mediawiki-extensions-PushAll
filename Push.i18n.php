...
$messages['fa'] = array(
	...
	'right-push' => 'استفاده از قابلیت‌های فشار',
	'right-bulkpush' => 'استفاده از قابلیت‌های فشار عمده (یعنی ویژه: فشار)',
	'right-pushadmin' => 'تغییر اهداف فشار و تنظیمات فشار',
	'action-push' => 'صفحات فشار',
	'action-bulkpush' => 'صفحات فشار عمده',
	'action-pushadmin' => 'پیکربندی فشار',
	'group-pusher' => 'فشاردهنده‌ها',
	'group-pusher-member' => '{{GENDER:$1|فشاردهنده}}',
	'grouppage-pusher' => '{{ns:project}}:فشاردهندگان',
	'group-bulkpusher' => 'فشاردهندگان عمده',
	'group-bulkpusher-member' => '{{GENDER:$1|فشاردهندهٔ عمده}}',
	'grouppage-bulkpusher' => '{{ns:project}}: فشاردهندگان عمده',
	'group-filepusher' => 'فشاردهندگان پوشه',
	'group-filepusher-member' => '{{GENDER:$1|فشاردهندهٔ پوشه}}',
	'grouppage-filepusher' => '{{ns:project}}: فشاردهندگان پوشه',
	'push-err-captacha' => 'نتوانست به علت سی‌ای‌پی‌تی‌سی‌اچ‌ای به $1  فشار دهد.',
	'push-err-captcha-page' => 'نتوانست صفحه $1 را برای همهٔ اهداف به علت سی‌ای‌پی‌تی‌سی‌اچ‌ای فشار دهد.',
	...
	'push-button-failed' => 'فشار انجام نشد',
	'push-tab-title' => 'فشار $1',
	...
	'push-targets-total' => 'مجموع $1 {{PLURAL:$1|هدف|اهداف}} وجود دارند.',
	'push-button-all' => 'فشار همه',
	'push-tab-last-edit' => 'آخرین ویرایش توسط $1 در $2 در $3.',
	'push-tab-not-created' => 'این صفحه هنوز وجود ندارد.',
	'push-tab-push-options' => 'گزینه‌های فشار:',
...
این می تواند مدتی برای کامل شدن طول بکشد.',
	...
	'push-special-item-pushing' => '$1: فشار دادن',
	'push-special-item-completed' => '$1: فشار کامل شد',
	'push-special-item-failed' => '$1: فشار انجام نشد: $2',
	'push-special-push-done' => 'فشار کامل شد',
	'push-special-err-token-failed' => 'نتوانست یک نشان ویرایش در ویکی هدف به دست آورد.',
	'push-special-err-pageget-failed' => 'نتوانست محتوای صفحهٔ داخلی را به دست آورد.',
	'push-special-err-push-failed' => 'هدف ویکی صفحه فشرده را رد کرد.',
	'push-special-inc-files' => 'شامل پوشه‌های ضمیمه شده',
	'push-special-err-imginfo-failed' => 'نتوانست تعیین کند اینکه اگر صفحه‌ای نیاز یه تحت فشار قرار گرفتن باشد را تعیین کند.',
...
$messages['hsb'] = array(
	...
	'right-push' => 'Přenošowansku funkcionalnosć wužiwać',
	'right-bulkpush' => 'Přenošowansku funkcionalnosć z masami (t. j. Special:Push) wužiwać',
	'right-pushadmin' => 'Přenošowanske cile a přenošowanske nastajenja změnić',
	...
	'push-tab-files-override' => '{{PLURAL:$2|Tuta dataja hižo eksistuje|Tutej dataji hižo eksistujetej|Tute dataje hižo eksistuja}}: $1',
	'push-tab-template-override' => '{{PLURAL:$2|Tuta předłoha hižo eksistuje|Tutej předłoze hižo eksistujetej|Tute předłohi hižo eksistuja}}: $1',
...
공개 위키에서 $egPushDirectFileUploads를 false로 설정하거나 비공개 위키에 cURL을 설치하세요',
	'push-api-err-nofilesupport' => '로컬 미디어위키에 파일을 게시하는 데에 지원이 없습니다.
공개 위키의 경우 $egPushDirectFileUploads를 false로 설정하세요.
비공개 위키의 경우 밀기 설명서 또는 미디어위키 자체에서 업데이트하여 링크한 패치를 적용하세요.',
);
...
$messages['mk'] = array(
	...
	'push-tab-desc' => 'Ова јазиче ви овозможува да ја пренесете тековната преработка на страницава на едно или повеќе викија',
...
Наместете го $egPushDirectFileUploads на „false“ на јавните викија, или пак воспоставете го cURL на личните викија',
...
На лични викија, ставете ја поправката linkd од документацијата на Push или подновете го самиот МедијаВики.',
);
...
$messages['zh-hans'] = array(
	...
	'right-push' => '使用推送功能',
	'right-bulkpush' => '使用批量推送功能（即Special:Push）',
	'right-pushadmin' => '修改推送目标和推送设置',
	'action-push' => '推送页面',
	...
	'push-tab-text' => '推送',
	'push-button-text' => '推送',
	'push-tab-desc' => '此标签允许你推送此页面的当前修订到一个或多个其他wiki。',
	'push-button-pushing' => '推送中',
	'push-button-pushing-files' => '正在推送文件',
	'push-button-completed' => '推送完成',
	'push-button-failed' => '推送失败',
	'push-tab-title' => '推送$1',
	'push-targets' => '推送目标',
	'push-add-target' => '新增目标',
	'push-import-revision-message' => '已从$1推送。',
	'push-tab-no-targets' => '还没有要推送的目标。请添加一些到你的LocalSettings.php文件。',
	'push-tab-push-to' => '推送到$1',
	'push-remote-pages' => '远程页面',
	'push-remote-page-link' => '$2上的$1',
	'push-remote-page-link-full' => '查看$2上的$1',
	'push-targets-total' => '总共有$1个目标。',
	'push-button-all' => '推送全部',
	'push-tab-last-edit' => '最后编辑由$1，于$3在$2。',
